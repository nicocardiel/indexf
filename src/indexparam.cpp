...
IndexParam::IndexParam(
  ...
  long vacuum_,                 //vacuum wavelength scale in spectra
  ...
  bool pyindexf_)              //echo data for communication with python scripts
{
  set_if(ifile_);
  set_ns1(ns1_);
  set_ns2(ns2_);
...
//-----------------------------------------------------------------------------
void IndexParam::set_boundfit(const long boundfit_)
{
  boundfit = boundfit_;
}
...
//-----------------------------------------------------------------------------
void IndexParam::set_vacuum(const long vacuum_)
{
  vacuum=vacuum_;
}
...
//-----------------------------------------------------------------------------
void IndexParam::set_pyindexf(const bool pyindexf_)
{
  pyindexf=pyindexf_;
}
...
//-----------------------------------------------------------------------------
long IndexParam::get_vacuum() {return(vacuum);}
...
//-----------------------------------------------------------------------------
bool IndexParam::get_pyindexf() {return(pyindexf);}
